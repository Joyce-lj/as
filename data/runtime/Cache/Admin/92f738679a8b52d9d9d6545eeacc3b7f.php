...
<link href="/aishe0816-2/public/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css?page=index"  rel="stylesheet" type="text/css">
<!--[if IE 7]>
	<link rel="stylesheet" href="/aishe0816-2/public/simpleboot/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
<![endif]-->
<link rel="stylesheet" href="/aishe0816-2/public/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<link href="/aishe0816-2/public/js/artDialog/skins/default.css" rel="stylesheet" />
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/aishe0816-2/public/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
<body style="min-width:900px;" screen_capture_injected="true">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<!--<div class="pull-left nav_shortcuts" >-->
					...
					<!--<a class="btn btn-small btn-warning" href="/aishe0816-2/" title="<?php echo L('WEBSITE_HOME_PAGE');?>" target="_blank">-->
					...
					<!--<?php if(sp_auth_check(sp_get_current_admin_id(),'admin/setting/clearcache')): ?>-->
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							...
							<?php else: ?>
								<img class="nav-user-photo" width="30" height="30" src="/aishe0816-2/admin/themes/simplebootx/Public/assets/images/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>"><?php endif; ?>
	...
	<div class="main-container container-fluid">
		...
		<div class="main-content">
			<div class="breadcrumbs" id="breadcrumbs" style="display:block">
			...
			<div class="page-content" id="content">
				...
				<iframe src="<?php echo U('Housesource/index');?>" style="width:100%;height: 100%;" frameborder="0" id="" class="appiframe"></iframe>
			</div>
		</div>
	...
	<script src="/aishe0816-2/admin/themes/simplebootx/Public/assets/js/index.js"></script>
</body>
</html>